        ...
        <div class="agrupar">
            <section>
			    ...
			    <table border="1">
			    	...
			    	<tr><td>Nombre:</td><td><input type="text" name="txtNombre" id="Nombre" required/>*campo obligatorio</td></tr>
			    	...
			    	<tr><td>Mes y Año de nacimiento</td><td><input type="month" name="fecha" id="fecha"/></td></tr>
			    	<tr><td>Color Favorito:</td><td><input type="color" id= "Color" name="color" /></td></tr>
			    	...
			    	<tr><td>Clave:</td><td><input type="password" id="Clave" name="clave" required/>*campo obligatorio</td></tr>
